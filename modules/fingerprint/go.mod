...
require (
	...
	github.com/vistone/fingerprint/modules/frontend v1.0.6
	github.com/vistone/fingerprint/modules/gateway v1.0.6
	...
	github.com/vistone/fingerprint/modules/tls v1.0.6
)
