...
require (
	...
	github.com/vistone/fingerprint/modules/defense v1.0.5
	github.com/vistone/fingerprint/modules/errors v1.0.5
	github.com/vistone/fingerprint/modules/frontend v1.0.5
	github.com/vistone/fingerprint/modules/gateway v1.0.5
	github.com/vistone/fingerprint/modules/generator v1.0.5
	github.com/vistone/fingerprint/modules/http v1.0.5
	github.com/vistone/fingerprint/modules/internal v1.0.5
	github.com/vistone/fingerprint/modules/ml v1.0.5
	github.com/vistone/fingerprint/modules/profiles v1.0.5
	github.com/vistone/fingerprint/modules/tls v1.0.5
)
...
require (
	...
	github.com/vistone/fingerprint/modules/kit v1.0.5 // indirect
