...
require (
	...
	github.com/vistone/fingerprint/modules/frontend v1.0.26
	github.com/vistone/fingerprint/modules/gateway v1.0.26
	github.com/vistone/fingerprint/modules/generator v1.0.26
	...
	github.com/vistone/fingerprint/modules/tls v1.0.26
)
