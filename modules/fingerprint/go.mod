...
require (
	...
	github.com/vistone/fingerprint/modules/generator v1.0.20
	github.com/vistone/fingerprint/modules/http v1.0.20
	github.com/vistone/fingerprint/modules/internal v1.0.20
